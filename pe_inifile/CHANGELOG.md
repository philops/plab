...
This supported bugfix release corrects the peinifile section header detection
...
####Features
- Add quote_char parameter to the pe_ini_subsetting resource type
...
- Add mechanism for allowing pe_ini_setting subclasses to override the
formation of the namevar during .instances, to allow for pe_ini_setting
 ...
 * Added 'pe_ini_subsetting' custom resource type (4351d8b)
