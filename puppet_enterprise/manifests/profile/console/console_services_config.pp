...
class puppet_enterprise::profile::console::console_services_config (
  ...
  $tk_jetty_max_threads_api         = undef,
  $tk_jetty_max_threads_console     = undef,
  ...
  $cert_dir = "${puppet_enterprise::server_data_dir}/console-services/certs"
  ...
  if $tk_jetty_max_threads_console {
    pe_validate_single_integer($tk_jetty_max_threads_console)
  ...
  if $tk_jetty_max_threads_api {
    pe_validate_single_integer($tk_jetty_max_threads_api)
  ...
  $version_file = "${puppet_enterprise::server_data_dir}/console-services/pe_version"

  file { $version_file:
    content => $::pe_server_version,
  }
