...
describe 'puppet_enterprise::profile::console::console_services_config' do
  ...
  context "when the parameters are valid" do
    ...
    it { should contain_file("/opt/puppetlabs/server/data/console-services/pe_version").with_content('4.0.0') }
  end
  ...
  context "when configuring jetty SSL" do
    ...
    it { should contain_pe_hocon_setting('webserver.api.client-auth').with_value('need') }
