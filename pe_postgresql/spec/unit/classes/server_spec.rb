...
describe 'pe_postgresql::server', :type => :class do
  let :facts do
    {
      :osfamily => 'Debian',
  ...
  describe 'with no parameters' do
    ...
    it { should contain_class("pe_postgresql::server") }
    it 'should validate connection' do
      should contain_pe_postgresql__validate_db_connection('validate_service_is_running')
    end
  end
  ...
  describe 'service_ensure => stopped' do
    ...
    it 'shouldnt validate connection' do
      should_not contain_pe_postgresql__validate_db_connection('validate_service_is_running')
    end
  end
